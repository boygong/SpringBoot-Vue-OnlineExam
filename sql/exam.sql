DROP DATABASE IF EXISTS `test_online`;
...
(
    ...
    `adminName` varchar(20) NULL DEFAULT NULL COMMENT '姓名',
    `sex`       varchar(2)  NULL DEFAULT NULL COMMENT '性别',
    `tel`       varchar(11) NULL DEFAULT NULL COMMENT '电话号码',
    `email`     varchar(20) NULL DEFAULT NULL COMMENT '电子邮箱',
    `pwd`       varchar(16) NULL DEFAULT NULL COMMENT '密码',
    `cardId`    varchar(18) NULL DEFAULT NULL COMMENT '身份证号',
    `role`      varchar(1)  NULL DEFAULT NULL COMMENT '角色(0管理员，1教师，2学生)',
...
# ----------------------------
# Table structure for sys_choice_question
# ----------------------------
DROP TABLE IF EXISTS `sys_exam_manage`;
CREATE TABLE `sys_exam_manage`
(
    `examCode`    int(9)       NOT NULL AUTO_INCREMENT COMMENT '考试编号',
    `description` varchar(50)  NULL DEFAULT NULL COMMENT '该次考试介绍',
    `source`      varchar(20)  NULL DEFAULT NULL COMMENT '课程名称',
    `paperId`     int(10)      NULL DEFAULT NULL COMMENT '试卷编号',
    `examDate`    varchar(10)  NULL DEFAULT NULL COMMENT '考试日期',
    `totalTime`   int(3)       NULL DEFAULT NULL COMMENT '持续时长',
    `grade`       varchar(10)  NULL DEFAULT NULL COMMENT '年级',
    `term`        varchar(10)  NULL DEFAULT NULL COMMENT '学期',
    `major`       varchar(20)  NULL DEFAULT NULL COMMENT '专业',
    `institute`   varchar(20)  NULL DEFAULT NULL COMMENT '学院',
    `totalScore`  int(4)       NULL DEFAULT NULL COMMENT '总分',
    `type`        varchar(255) NULL DEFAULT NULL COMMENT '考试类型',
    `tips`        varchar(255) NULL DEFAULT NULL COMMENT '考生须知',
...
# ----------------------------
# Records of sys_exam_manage
# ----------------------------
INSERT INTO `sys_exam_manage`
...
# ----------------------------
DROP TABLE IF EXISTS `sys_fill_question`;
CREATE TABLE `sys_fill_question`
(
    `questionId` int(9)       NOT NULL AUTO_INCREMENT COMMENT '试题编号',
    `subject`    varchar(20)  NULL DEFAULT NULL COMMENT '考试科目',
    `question`   varchar(255) NULL DEFAULT NULL COMMENT '试题内容',
    `answer`     varchar(255) NULL DEFAULT NULL COMMENT '正确答案',
    `analysis`   varchar(255) NULL DEFAULT NULL COMMENT '题目解析',
    `score`      int(2)       NULL DEFAULT 2 COMMENT '分数',
    `level`      varchar(5)   NULL DEFAULT NULL COMMENT '难度等级',
    `section`    varchar(20)  NULL DEFAULT NULL COMMENT '所属章节',
    PRIMARY KEY (`questionId`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 10029
    COMMENT = '填空题题库'
  ROW_FORMAT = Dynamic;

# ----------------------------
# Records of sys_fill_question
# ----------------------------
INSERT INTO `sys_fill_question`
...
# ----------------------------
# Table structure for sys_fill_question
# ----------------------------
DROP TABLE IF EXISTS `sys_judge_question`;
CREATE TABLE `sys_judge_question`
(
    `questionId` int(9)       NOT NULL AUTO_INCREMENT COMMENT '试题编号',
    `subject`    varchar(20)  NULL DEFAULT NULL COMMENT '考试科目',
    `question`   varchar(255) NULL DEFAULT NULL COMMENT '试题内容',
...
# ----------------------------
# Records of sys_judge_question
# ----------------------------
INSERT INTO `sys_judge_question`
...
(
    ...
    `content` varchar(255) NULL DEFAULT NULL COMMENT '留言内容',
...
# ----------------------------
# Table structure for sys_multi_question
# ----------------------------
DROP TABLE IF EXISTS `sys_multi_question`;
CREATE TABLE `sys_multi_question`
(
    `questionId`  int(9)       NOT NULL AUTO_INCREMENT COMMENT '试题编号',
    `subject`     varchar(20)  NULL DEFAULT NULL COMMENT '考试科目',
    `question`    varchar(255) NULL DEFAULT NULL COMMENT '问题题目',
    `answerA`     varchar(255) NULL DEFAULT NULL COMMENT '选项A',
    `answerB`     varchar(255) NULL DEFAULT NULL COMMENT '选项B',
    `answerC`     varchar(255) NULL DEFAULT NULL COMMENT '选项C',
    `answerD`     varchar(255) NULL DEFAULT NULL COMMENT '选项D',
    `rightAnswer` varchar(10)  NULL DEFAULT NULL COMMENT '正确答案',
    `analysis`    varchar(255) NULL DEFAULT NULL COMMENT '题目解析',
    `score`       int(2)       NULL DEFAULT 2 COMMENT '分数',
    `section`     varchar(20)  NULL DEFAULT NULL COMMENT '所属章节',
    `level`       varchar(1)   NULL DEFAULT NULL COMMENT '难度等级',
...
# ----------------------------
INSERT INTO `sys_multi_question`
...
# ----------------------------
DROP TABLE IF EXISTS `sys_paper_manage`;
CREATE TABLE `sys_paper_manage`
(
...
# ----------------------------
# Table structure for sys_replay
# ----------------------------
DROP TABLE IF EXISTS `sys_replay`;
CREATE TABLE `sys_replay`
(
    `messageId`  int(255)     NULL DEFAULT NULL COMMENT '留言编号',
    `replayId`   int(9)       NOT NULL AUTO_INCREMENT COMMENT '回复编号',
    `replay`     varchar(255) NULL DEFAULT NULL COMMENT '内容',
...
# ----------------------------
# Records of sys_replay
# ----------------------------
INSERT INTO `sys_replay`
...
(
    ...
    `answerDate` varchar(10) NULL DEFAULT NULL COMMENT '答题日期',
...
(
    ...
    `studentName` varchar(20) NULL DEFAULT NULL COMMENT '姓名',
    `grade`       varchar(4)  NULL DEFAULT NULL COMMENT '年级',
    `major`       varchar(20) NULL DEFAULT NULL COMMENT '专业',
    `clazz`       varchar(10) NULL DEFAULT NULL COMMENT '班级',
    `institute`   varchar(30) NULL DEFAULT NULL COMMENT '学院',
    `tel`         varchar(11) NULL DEFAULT NULL COMMENT '电话号码',
    `email`       varchar(30) NULL DEFAULT NULL COMMENT '电子邮件',
    `pwd`         varchar(16) NULL DEFAULT NULL COMMENT '密码',
    `cardId`      varchar(18) NULL DEFAULT NULL COMMENT '身份证号',
    `sex`         varchar(2)  NULL DEFAULT NULL COMMENT '性别',
    `role`        varchar(1)  NULL DEFAULT '2' COMMENT '角色(0管理员，1教师，2学生)',
    PRIMARY KEY (`studentId`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 20155009
    COMMENT = '学生信息表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `teacherName` varchar(20) NULL DEFAULT NULL COMMENT '姓名',
    `institute`   varchar(20) NULL DEFAULT NULL COMMENT '学院',
    `sex`         varchar(2)  NULL DEFAULT NULL COMMENT '性别',
    `tel`         varchar(11) NULL DEFAULT NULL COMMENT '电话号码',
    ...
    `pwd`         varchar(16) NULL DEFAULT NULL COMMENT '密码',
    `cardId`      varchar(18) NULL DEFAULT NULL COMMENT '身份证号',
    `type`        varchar(20) NULL DEFAULT NULL COMMENT '职称',
    `role`        varchar(1)  NULL DEFAULT NULL COMMENT '角色（0管理员，1教师，2学生）',
    PRIMARY KEY (`teacherId`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 20081003
    COMMENT = '教师信息表'
  ROW_FORMAT = Dynamic;
